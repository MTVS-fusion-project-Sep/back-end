...
@Getter
public class InterestV2UpdateDTO {
    ...
    public InterestV2UpdateDTO() {
    }

    public InterestV2UpdateDTO(Long id, String userId, String likeCount, String bigCategory, String smallCategory, String bigCategory2, String smallCategory2, String bigCategory3, String smallCategory3) {
        this.id = id;
        this.userId = userId;
